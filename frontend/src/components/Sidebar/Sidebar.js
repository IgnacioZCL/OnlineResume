  ...
  const Sidebar = () => {
    ...
    return (
      <div style={{ display: 'flex', minHeight: '100vh', overflow: 'scroll initial' }}>
        <CDBSidebar textColor="#000" className="light-blue-background" maxWidth='300px'>
          ...
          <CDBSidebarContent className="sidebar-content">
            <CDBSidebarMenu>
              <CDBSidebarMenuItem icon="phone"><a href="tel:+56951386005">+569 5138 6005</a></CDBSidebarMenuItem>
              <CDBSidebarMenuItem icon="envelope"><a href="mailto:ignacio.f.zuniga@gmail.com">ignacio.f.zuniga@gmail.com</a></CDBSidebarMenuItem>
              <CDBSidebarMenuItem icon="map" className="address">Avenida San Joaquín 0710,<br/> depto 703, Rancagua, Chile.</CDBSidebarMenuItem>
              ...
              <CDBSidebarMenu>
                <CDBSidebarMenuItem icon="code" className="blue-background white-text">{t("sidebar.technologies")} </CDBSidebarMenuItem>
                <ul>
                  <li>Python</li>
                  <li>Django</li>
                  <li>MySQL</li>
                ...
                <CDBSidebarMenuItem icon="globe" className="blue-background white-text">{t("sidebar.languages")}</CDBSidebarMenuItem>
                <ul>
